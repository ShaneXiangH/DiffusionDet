...
```bash
python train_net.py --num-gpus 1 --config-file configs/diffdet.coco.res50.yaml --eval-only MODEL.WEIGHTS output/Tra_coco_full_45000_res50/model_0180000_final.pth MODEL.DiffusionDet.SAMPLE_STEP 4 OUTPUT_DIR "./output/Eva_coco_full_180000_res50"
```
